...
static void handle_send_erc_20_tokens_paramters(ethPluginProvideParameter_t *msg, context_t *context) {
...
static void handle_send_native_tokens_paramters(ethPluginProvideParameter_t *msg, context_t *context) {
    if (context->go_to_offset) {
        return;
    }
...
static void handle_pegged_token_deposit(ethPluginProvideParameter_t *msg, context_t *context) {
    if (context->go_to_offset) {
        return;
    }
...
static void handle_pegged_token_burn(ethPluginProvideParameter_t *msg, context_t *context) {
    if (context->go_to_offset) {
        return;
    }
